...
#screen.blit(iconpopup, iconpopup_coords)
coo=(500,750)
increment=0.2
cont=True
while cont:
...
images = [(background, (0,0)), (iconterminal, iconterminal_coords), (iconmessage, iconmessage_coords),(iconpopup, coo)] #Prépare la liste pour l'affichage des éléments
