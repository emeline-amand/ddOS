...
def message(_images, _messages, g_compte, compte, utilisateur, g_champ, g_countreturn, text) :
	...
	if g_compte == 1:
		...
		if g_countreturn == 0:
			...
			#variable retour qui permet de cliquer sur "retour" lorsqu'on se 
			retour=0
			connexion = 2
			pygame.display.flip()
